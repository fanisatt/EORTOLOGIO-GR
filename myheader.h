...
// extern void *greek_addr, *souv_addr , *mem_sarial , *mem_times , *mem_sans , *mem_caviar , *mem_impact ; 
...
extern int notes_font , eortes_font , names_font , ponom_font , eortologio_font , pagkosm_font , personal_font , mobeort_font ;
